...
const GLOBAL_DESC = {
    ...
    deckCapacity: '卡包总容量（卡包道具 stats[167]，arena_server.lua L8154；默认为初始卡包 kids 14 / teen 18）。预设卡组按此容量配卡，卡包用完只能跳过',
    deckEachCapacity: '单卡上限（stats[170]，arena_server.lua L8087；teen 同名技能共享）',
